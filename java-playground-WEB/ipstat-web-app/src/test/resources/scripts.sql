...
INSERT INTO player ("name","role",price,country,team) VALUES
	 ...
	 ('SubhranshuSenapati','Batsman',2000000.0,'India','CSK'),
	 ('HariNishaanth','Batsman',2000000.0,'India','CSK'),
	 ('NJagadeesan','WK-Batsman',2000000.0,'India','CSK'),
	 ('DeepakChahar','Bowler',140000000,'India','CSK'),
	 ('KMAsif','Bowler',2000000.0,'India','CSK');
INSERT INTO player ("name","role",price,country,team) VALUES
	 ('TusharDeshpande','Bowler',2000000.0,'India','CSK'),
	 ('MaheeshTheekshana','Bowler',7000000.0,'Sri Lanka','CSK'),
	 ('SimranjeetSingh','Bowler',2000000.0,'India','CSK'),
	 ('AdamMilne','Bowler',19000000,'New Zealand','CSK'),
	 ('MukeshChoudhary','Bowler',2000000.0,'India','CSK'),
...
INSERT INTO player ("name","role",price,country,team) VALUES
	 ...
	 ('DwainePretorius','All-rounder',5000000.0,'South Africa','CSK'),
	 ('BhagathVarma','All-rounder',2000000.0,'India','CSK'),
	 ('ChrisJordan','All-rounder',36000000,'England','CSK'),
	 ('MananVohra','Batsman',2000000.0,'India','LSG'),
...
INSERT INTO player ("name","role",price,country,team) VALUES
	 ...
	 ('ShahbazNadeem','Bowler',5000000.0,'India','LSG'),
	 ('MohsinKhan','Bowler',2000000.0,'India','LSG'),
	 ('MayankYadav','Bowler',2000000.0,'India','LSG'),
	 ('AnkitRajpoot','Bowler',5000000.0,'India','LSG'),
	 ('AveshKhan','Bowler',100000000,'India','LSG'),
	 ('MarkWood','Bowler',75000000,'England','LSG'),
	 ('MarcusStoinis','All-rounder',92000000,'Australia','LSG'),
	 ('KyleMayers','All-rounder',5000000.0,'West Indies','LSG');
INSERT INTO player ("name","role",price,country,team) VALUES
	 ('KaranSharma','All-rounder',2000000.0,'India','LSG'),
	 ('KGowtham','All-rounder',9000000.0,'India','LSG'),
	 ('AyushBadoni','All-rounder',2000000.0,'India','LSG'),
	 ...
	 ('PrerakMankad','Batsman',2000000.0,'India','PBKS'),
	 ('BhanukaRajapaksa','Batsman',5000000.0,'Sri Lanka','PBKS'),
	 ('ShahrukhKhan','Batsman',90000000,'India','PBKS');
INSERT INTO player ("name","role",price,country,team) VALUES
	 ('ShikharDhawan','Batsman',82500000,'India','PBKS'),
	 ('PrabhsimranSingh','WK-Batsman',6000000.0,'India','PBKS'),
	 ('JiteshSharma','WK-Batsman',2000000.0,'India','PBKS'),
	 ('JonnyBairstow','WK-Batsman',67500000,'England','PBKS'),
	 ('ArshdeepSingh','Bowler',40000000,'India','PBKS'),
	 ('WrittickChatterjee','Bowler',2000000.0,'India','PBKS'),
	 ('OdeanSmith','Bowler',60000000,'West Indies','PBKS'),
	 ('SandeepSharma','Bowler',5000000.0,'India','PBKS'),
	 ('RajBawa','Bowler',20000000,'India','PBKS'),
	 ('NathanEllis','Bowler',7500000.0,'Australia','PBKS');
INSERT INTO player ("name","role",price,country,team) VALUES
	 ('VaibhavArora','Bowler',20000000,'India','PBKS'),
	 ('IshanPorel','Bowler',2500000.0,'India','PBKS'),
	 ...
	 ('BennyHowell','All-rounder',4000000.0,'England','PBKS'),
	 ('BaltejSingh','All-rounder',2000000.0,'India','PBKS'),
	 ('AnshPatel','All-rounder',2000000.0,'India','PBKS'),
	 ('LiamLivingstone','All-rounder',115000000,'England','PBKS'),
	 ('RishiDhawan','All-rounder',5500000.0,'India','PBKS');
INSERT INTO player ("name","role",price,country,team) VALUES
	 ('AtharvaTaide','All-rounder',2000000.0,'India','PBKS'),
	 ('KaneWilliamson','Batsman',140000000,'New Zealand','SRH'),
	 ('AidenMarkram','Batsman',26000000,'South Africa','SRH'),
	 ('ShashankSingh','Batsman',2000000.0,'India','SRH'),
	 ('RSamarth','Batsman',2000000.0,'India','SRH'),
	 ('RahulTripathi','Batsman',85000000,'India','SRH'),
	 ('PriyamGarg','Batsman',2000000.0,'India','SRH'),
	 ('GlennPhillips','WK-Batsman',15000000,'New Zealand','SRH'),
	 ('VishnuVinod','WK-Batsman',5000000.0,'India','SRH'),
	 ('NicholasPooran','WK-Batsman',107500000,'West Indies','SRH');
INSERT INTO player ("name","role",price,country,team) VALUES
	 ('UmranMalik','Bowler',40000000,'India','SRH'),
	 ('SaurabhDubey','Bowler',2000000.0,'India','SRH'),
	 ('RomarioShepherd','Bowler',77500000,'West Indies','SRH'),
	 ('FazalHaqFarooqi','Bowler',5000000.0,'Afghanistan','SRH'),
	 ('JSuchith','Bowler',2000000.0,'India','SRH'),
	 ('ShreyasGopal','Bowler',7500000.0,'India','SRH'),
